1.2.0 - El Sequito del Terror Edition (Enero 2026)
- Sistema completo de localizacion para cliente en español
- Base de datos con 100+ hechizos traducidos (Español→Inglés)
- Hooks automaticos para traduccion de hechizos en tiempo real
- Nuevos comandos: /dotimerdiag, /dotimerspells, /dotimer debug on/off
- Archivos nuevos: DoTimer_SpellLocalization.lua, DoTimer_Patch.lua
